...
contract Crowdsale {
    ...
    /**
     * @param _rate_ Number of token units a buyer gets per wei
     ...
     */
    constructor (uint256 _rate_, address payable _wallet_, IERC20 _token_) {
        require(_rate_ > 0, "Crowdsale: rate is 0");
        require(_wallet_ != address(0), "Crowdsale: wallet is the zero address");
        require(address(_token_) != address(0), "Crowdsale: token is the zero address");
